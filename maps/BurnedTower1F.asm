...
BurnedTower1F_MapEvents:
	...
	object_event 2,  13, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, BurnedTower1PoisonStone, EVENT_BURNED_TOWER_1F_POISON_STONE
