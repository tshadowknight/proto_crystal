...
; pointers to the first map of each map group
	...
	dw MapGroup_FarawayIsland
	dw MapGroup_CeruleanCave
...
MapGroup_FarawayIsland:
	map FarawayIslandExterior, TILESET_JOHTO, ROUTE, FARAWAY_ISLAND, MUSIC_ROUTE_30, TRUE, PALETTE_AUTO, FISHGROUP_POND
	map FarawayIslandInterior, TILESET_PARK, ROUTE, FARAWAY_ISLAND, MUSIC_RUINS_OF_ALPH_INTERIOR, TRUE, PALETTE_AUTO, FISHGROUP_POND
	
MapGroup_CeruleanCave:
	map CeruleanCave1F, TILESET_CAVE, CAVE, CERULEAN_CITY, MUSIC_LIGHTHOUSE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map CeruleanCave2F, TILESET_CAVE, CAVE, CERULEAN_CITY, MUSIC_LIGHTHOUSE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map CeruleanCave1BF, TILESET_CAVE, CAVE, CERULEAN_CITY, MUSIC_LIGHTHOUSE, TRUE, PALETTE_NITE, FISHGROUP_LAKE