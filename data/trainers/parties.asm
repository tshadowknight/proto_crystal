...
PryceGroup:
	...
	db 31, WARWOLF,  ICY_WIND, FURY_ATTACK, MIST, BLIZZARD
	db -1 ; end
...
SchoolboyGroup:
	...
	db 32, BULBASAUR,      QUICK_ATTACK, DOUBLE_TEAM, SONICBOOM, SUPERSONIC
...
BlaineGroup:
	...
	db 45, BULBASAUR,   CURSE, SMOG, FLAMETHROWER, ROCK_SLIDE
...
CamperGroup:
	...
	db 33, GRAVELER,   SELFDESTRUCT, ROCK_THROW, HARDEN, MAGNITUDE
	db 36, BULBASAUR,   ROCK_THROW, HARDEN, AMNESIA, FLAMETHROWER
