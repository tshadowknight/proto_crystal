...
MortyGroup:
	...
	db 22, PANGSHI,    SHADOW_BALL, MIMIC, CURSE, TRIPLE_KICK
...
PryceGroup:
	...
	db 31, WARWOLF,  ICY_WIND, SLASH, MIST, BLIZZARD
	db -1 ; end
...
Rival1Group:
	...
	db 22, BLOSSOMOLE,    GROWL, REFLECT, RAZOR_LEAF, POISONPOWDER
	db -1 ; end
	...
	db 18, MAGNEMITE,  TACKLE, THUNDERSHOCK, SUPERSONIC, SONICBOOM
	db 20, ZUBAT,      LEECH_LIFE, SUPERSONIC, BITE, CONFUSE_RAY
	db 22, VOLBEAR,    LEER, SMOKESCREEN, EMBER, QUICK_ATTACK
	db -1 ; end
	...
	db 18, MAGNEMITE,  TACKLE, THUNDERSHOCK, SUPERSONIC, SONICBOOM
	db 20, ZUBAT,      LEECH_LIFE, SUPERSONIC, BITE, CONFUSE_RAY
	db 22, AQUA,   LEER, RAGE, WATER_GUN, BITE
	db -1 ; end
	...
	db 32, BLOSSOMITE,   REFLECT, RAZOR_LEAF, POISONPOWDER, BODY_SLAM
	db -1 ; end
	...
	db 30, HAUNTER,    LICK, MEAN_LOOK, CURSE, SHADOW_BALL
	db 32, SNEASEL,    LEER, QUICK_ATTACK, SCREECH, FAINT_ATTACK
	db 32, VOLBEAR,    SMOKESCREEN, EMBER, QUICK_ATTACK, FLAME_WHEEL
	db -1 ; end
	...
	db 30, HAUNTER,    LICK, MEAN_LOOK, CURSE, SHADOW_BALL
	db 32, SNEASEL,    LEER, QUICK_ATTACK, SCREECH, FAINT_ATTACK
	db 32, AQUARIA, RAGE, WATER_GUN, BITE, SCARY_FACE
	db -1 ; end
	...
	db 38, BLOSSOMITE,   REFLECT, RAZOR_LEAF, POISONPOWDER, BODY_SLAM
	db -1 ; end
	...
	db 35, HAUNTER,    MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 35, KADABRA,    DISABLE, PSYBEAM, RECOVER, FUTURE_SIGHT
	db 38, DYNABEAR, SMOKESCREEN, EMBER, QUICK_ATTACK, FLAME_WHEEL
	db -1 ; end
	...
	db 35, HAUNTER,    MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 35, KADABRA,    DISABLE, PSYBEAM, RECOVER, FUTURE_SIGHT
	db 38, AQUARIA, RAGE, WATER_GUN, SCARY_FACE, SLASH
	db -1 ; end
...
KarenGroup:
	...
	db 42, BELLBOYANT,  CRUNCH, PSYCHIC_M, MOONLIGHT, SWAGGER
...
KogaGroup:
	...
	db 43, WEEZING,    PROTECT, TOXIC, EXPLOSION, SLUDGE_BOMB
...
BrockGroup:
	...
	db 42, GOLEM,   DEFENSE_CURL, ROCK_SLIDE, ROLLOUT, EARTHQUAKE
	db 42, RHYDON,    ROCK_SLIDE, SCARY_FACE, EARTHQUAKE, HORN_DRILL
	db 43, OMASTAR,    BITE, SURF, PROTECT, SPIKE_CANNON
	db 44, ONIX,       BIND, ROCK_SLIDE, BIDE, SANDSTORM
	db 43, KABUTOPS,   SLASH, SURF, ENDURE, GIGA_DRAIN
	db -1 ; end
...
MistyGroup:
	...
	db 42, NUMPUFF,    SURF, ICE_BEAM, PIN_MISSILE, TAKE_DOWN
...
LtSurgeGroup:
	...
	db 42, RAITORA,  THUNDERBOLT, BODY_SLAM, EARTHQUAKE, THUNDER_WAVE
...
ErikaGroup:
	...
	db 41, COTTOMEW,   MEGA_DRAIN, LEECH_SEED, COTTON_SPORE, GIGA_DRAIN
	db 46, BELLMITT, SUNNY_DAY, SYNTHESIS, SLUDGE_BOMB, SOLARBEAM
...
BirdKeeperGroup:
	...
	db 38, MADAME,    WING_ATTACK, SLASH, SWORDS_DANCE, FLY
...
CooltrainerMGroup:
	...
	db 35, BOMSEEL,    SURF, FLAMETHROWER, SMOKESCREEN, SUNNY_DAY
	db -1 ; end
	...
	db 33, RAITORA,   SPARK, BODY_SLAM, DEFENSE_CURL, ROLLOUT
...
CooltrainerFGroup:
	...
	db 25, DANDEMEW,   SYNTHESIS, POISONPOWDER, MEGA_DRAIN, LEECH_SEED
...
BeautyGroup:
	...
	db 17, LEFMEW,     SYNTHESIS, TAIL_WHIP, TACKLE, POISONPOWDER
	db 17, DANDEMEW,   SYNTHESIS, TAIL_WHIP, TACKLE, STUN_SPORE
	db -1 ; end
...
FisherGroup:
	...
	db 25, ANCHORAGE,   LOCK_ON, PSYBEAM, AURORA_BEAM, BUBBLEBEAM
	db -1 ; end
...
Rival2Group:
	...
	db 45, BLOSSOMITE,   RAZOR_LEAF, POISONPOWDER, BODY_SLAM, LIGHT_SCREEN
	db -1 ; end
	...
	db 43, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 43, ALAKAZAM,   DISABLE, RECOVER, FUTURE_SIGHT, PSYCHIC_M
	db 45, DYNABEAR, SMOKESCREEN, QUICK_ATTACK, FLAME_WHEEL, SWIFT
	db -1 ; end
	...
	db 43, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 43, ALAKAZAM,   DISABLE, RECOVER, FUTURE_SIGHT, PSYCHIC_M
	db 45, AQUARIA, RAGE, WATER_GUN, SCARY_FACE, SLASH
	db -1 ; end
	...
	db 50, BLOSSOMITE,   GIGA_DRAIN, BODY_SLAM, LIGHT_SCREEN, SAFEGUARD
	db -1 ; end
	...
	db 46, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 46, ALAKAZAM,   RECOVER, FUTURE_SIGHT, PSYCHIC_M, REFLECT
	db 50, AQUARIA, SURF, RAIN_DANCE, SLASH, SCREECH
	db -1 ; end
...
HikerGroup:
	...
	db 35, WARWOLF,  EARTHQUAKE, BLIZZARD, REST, TAKE_DOWN
...
BlaineGroup:
	...
	db 45, BOMSEEL,   SURF, PROTECT, FLAMETHROWER, SMOKESCREEN
...
PicnickerGroup:
	...
	db 16, KOTORA,    THUNDERSHOCK, GROWL, QUICK_ATTACK, DOUBLE_TEAM
	db -1 ; end
	...
	db 33, COTTOMEW,   STUN_SPORE, SUNNY_DAY, LEECH_SEED, COTTON_SPORE
	db 33, COTTOMEW,   SUNNY_DAY, SLEEP_POWDER, LEECH_SEED, COTTON_SPORE
