...
HoOhFrontpic:        INCBIN "gfx/pokemon/aipom/front.animated.2bpp.lz"
...
FeraligatrFrontpic:  INCBIN "gfx/pokemon/aquaria/front.animated.2bpp.lz"
NidokingFrontpic:    INCBIN "gfx/pokemon/nidoking/front.animated.2bpp.lz"
RaikouFrontpic:      INCBIN "gfx/pokemon/rai/front.animated.2bpp.lz"
LugiaFrontpic:       INCBIN "gfx/pokemon/snubbull/front.animated.2bpp.lz"
...
EnteiFrontpic:       INCBIN "gfx/pokemon/en/front.animated.2bpp.lz"
SuicuneFrontpic:     INCBIN "gfx/pokemon/sui/front.animated.2bpp.lz"
TyphlosionFrontpic:  INCBIN "gfx/pokemon/dynabear/front.animated.2bpp.lz"
; 123ffa
...
MeganiumFrontpic:    INCBIN "gfx/pokemon/blossomite/front.animated.2bpp.lz"
...
ScizorFrontpic:      INCBIN "gfx/pokemon/hitmontop/front.animated.2bpp.lz"
...
TyranitarFrontpic:   INCBIN "gfx/pokemon/togepi/front.animated.2bpp.lz"
...
QuilavaFrontpic:     INCBIN "gfx/pokemon/volbear/front.animated.2bpp.lz"
; 127ffe


SECTION "Pics 3", ROMX

SteelixFrontpic:     INCBIN "gfx/pokemon/grimey/front.animated.2bpp.lz"
...
SkarmoryFrontpic:    INCBIN "gfx/pokemon/raitora/front.animated.2bpp.lz"
...
SlowkingFrontpic:    INCBIN "gfx/pokemon/politoed/front.animated.2bpp.lz"
HitmontopFrontpic:   INCBIN "gfx/pokemon/wolfman/front.animated.2bpp.lz"
OnixFrontpic:        INCBIN "gfx/pokemon/onix/front.animated.2bpp.lz"
BlisseyFrontpic:     INCBIN "gfx/pokemon/kingdra/front.animated.2bpp.lz"
...
CroconawFrontpic:    INCBIN "gfx/pokemon/aqua/front.animated.2bpp.lz"
...
DonphanFrontpic:     INCBIN "gfx/pokemon/blissey/front.animated.2bpp.lz"
...
MagcargoFrontpic:    INCBIN "gfx/pokemon/elekid/front.animated.2bpp.lz"
PersianFrontpic:     INCBIN "gfx/pokemon/persian/front.animated.2bpp.lz"
StantlerFrontpic:    INCBIN "gfx/pokemon/plux/front.animated.2bpp.lz"
...
PolitoedFrontpic:    INCBIN "gfx/pokemon/ariados/front.animated.2bpp.lz"
ElectabuzzFrontpic:  INCBIN "gfx/pokemon/electabuzz/front.animated.2bpp.lz"
MantineFrontpic:     INCBIN "gfx/pokemon/kotora/front.animated.2bpp.lz"
LickitungFrontpic:   INCBIN "gfx/pokemon/lickitung/front.animated.2bpp.lz"
KingdraFrontpic:     INCBIN "gfx/pokemon/pangshi/front.animated.2bpp.lz"
...
AzumarillFrontpic:   INCBIN "gfx/pokemon/para/front.animated.2bpp.lz"
...
HeracrossFrontpic:   INCBIN "gfx/pokemon/lefmew/front.animated.2bpp.lz"
; 133fff


SECTION "Pics 6", ROMX

AriadosFrontpic:     INCBIN "gfx/pokemon/gelanla/front.animated.2bpp.lz"
NoctowlFrontpic:     INCBIN "gfx/pokemon/flaaffy/front.animated.2bpp.lz"
...
UrsaringFrontpic:    INCBIN "gfx/pokemon/ballerine/front.animated.2bpp.lz"
HoundoomFrontpic:    INCBIN "gfx/pokemon/kurstraw/front.animated.2bpp.lz"
KabutopsFrontpic:    INCBIN "gfx/pokemon/kabutops/front.animated.2bpp.lz"
AmpharosFrontpic:    INCBIN "gfx/pokemon/anchorage/front.animated.2bpp.lz"
...
BayleefFrontpic:     INCBIN "gfx/pokemon/blossomole/front.animated.2bpp.lz"
...
ElekidFrontpic:      INCBIN "gfx/pokemon/porygon2/front.animated.2bpp.lz"
JumpluffFrontpic:    INCBIN "gfx/pokemon/douno/front.animated.2bpp.lz"
...
GligarFrontpic:      INCBIN "gfx/pokemon/turbann/front.animated.2bpp.lz"
DunsparceFrontpic:   INCBIN "gfx/pokemon/umbreon/front.animated.2bpp.lz"
; 137fff
...
GirafarigFrontpic:   INCBIN "gfx/pokemon/tripstar/front.animated.2bpp.lz"
DrowzeeFrontpic:     INCBIN "gfx/pokemon/drowzee/front.animated.2bpp.lz"
SneaselFrontpic:     INCBIN "gfx/pokemon/dandemew/front.animated.2bpp.lz"
BellossomFrontpic:   INCBIN "gfx/pokemon/grotess/front.animated.2bpp.lz"
...
YanmaFrontpic:       INCBIN "gfx/pokemon/twinz/front.animated.2bpp.lz"
SmeargleFrontpic:    INCBIN "gfx/pokemon/houndour/front.animated.2bpp.lz"
...
MurkrowFrontpic:     INCBIN "gfx/pokemon/bellboyant/front.animated.2bpp.lz"
...
LedybaFrontpic:      INCBIN "gfx/pokemon/ampharos/front.animated.2bpp.lz"
...
PiloswineFrontpic:   INCBIN "gfx/pokemon/bellossom/front.animated.2bpp.lz"
...
ForretressFrontpic:  INCBIN "gfx/pokemon/espeon/front.animated.2bpp.lz"
TogeticFrontpic:     INCBIN "gfx/pokemon/natu/front.animated.2bpp.lz"
...
CrobatFrontpic:      INCBIN "gfx/pokemon/rayleep/front.animated.2bpp.lz"
...
SnubbullFrontpic:    INCBIN "gfx/pokemon/remoraid/front.animated.2bpp.lz"
GranbullFrontpic:    INCBIN "gfx/pokemon/octillery/front.animated.2bpp.lz"
MiltankFrontpic:     INCBIN "gfx/pokemon/steelix/front.animated.2bpp.lz"
HaunterFrontpic:     INCBIN "gfx/pokemon/haunter/front.animated.2bpp.lz"
SunfloraFrontpic:    INCBIN "gfx/pokemon/donphan/front.animated.2bpp.lz"
UmbreonFrontpic:     INCBIN "gfx/pokemon/rinring/front.animated.2bpp.lz"
ChikoritaFrontpic:   INCBIN "gfx/pokemon/leef/front.animated.2bpp.lz"
GoldeenFrontpic:     INCBIN "gfx/pokemon/goldeen/front.animated.2bpp.lz"
EspeonFrontpic:      INCBIN "gfx/pokemon/meowsy/front.animated.2bpp.lz"
XatuFrontpic:        INCBIN "gfx/pokemon/golppy/front.animated.2bpp.lz"
MewFrontpic:         INCBIN "gfx/pokemon/mew/front.animated.2bpp.lz"
OctilleryFrontpic:   INCBIN "gfx/pokemon/bomseel/front.animated.2bpp.lz"
JynxFrontpic:        INCBIN "gfx/pokemon/jynx/front.animated.2bpp.lz"
WobbuffetFrontpic:   INCBIN "gfx/pokemon/ledyba/front.animated.2bpp.lz"
DelibirdFrontpic:    INCBIN "gfx/pokemon/delibird/front.animated.2bpp.lz"
LedianFrontpic:      INCBIN "gfx/pokemon/trifox/front.animated.2bpp.lz"
GloomFrontpic:       INCBIN "gfx/pokemon/gloom/front.animated.2bpp.lz"
FlaaffyFrontpic:     INCBIN "gfx/pokemon/sunmola/front.animated.2bpp.lz"
IvysaurFrontpic:     INCBIN "gfx/pokemon/ivysaur/front.animated.2bpp.lz"
FurretFrontpic:      INCBIN "gfx/pokemon/hoohoo/front.animated.2bpp.lz"
CyndaquilFrontpic:   INCBIN "gfx/pokemon/flambear/front.animated.2bpp.lz"
HitmonchanFrontpic:  INCBIN "gfx/pokemon/hitmonchan/front.animated.2bpp.lz"
QuagsireFrontpic:    INCBIN "gfx/pokemon/smeargle/front.animated.2bpp.lz"
; 13fff7
...
SudowoodoFrontpic:   INCBIN "gfx/pokemon/spinarak/front.animated.2bpp.lz"
...
MagbyFrontpic:       INCBIN "gfx/pokemon/likk/front.animated.2bpp.lz"
WeepinbellFrontpic:  INCBIN "gfx/pokemon/weepinbell/front.animated.2bpp.lz"
TotodileFrontpic:    INCBIN "gfx/pokemon/cruz/front.animated.2bpp.lz"
CorsolaFrontpic:     INCBIN "gfx/pokemon/belmitt/front.animated.2bpp.lz"
FirebreatherPic:     INCBIN "gfx/trainers/firebreather.2bpp.lz"
MachopFrontpic:      INCBIN "gfx/pokemon/machop/front.animated.2bpp.lz"
ChinchouFrontpic:    INCBIN "gfx/pokemon/qwilfish/front.animated.2bpp.lz"
...
Porygon2Frontpic:    INCBIN "gfx/pokemon/scizor/front.animated.2bpp.lz"
...
MisdreavusFrontpic:  INCBIN "gfx/pokemon/slowking/front.animated.2bpp.lz"
HoundourFrontpic:    INCBIN "gfx/pokemon/madame/front.animated.2bpp.lz"
MankeyFrontpic:      INCBIN "gfx/pokemon/mankey/front.animated.2bpp.lz"
CelebiFrontpic:      INCBIN "gfx/pokemon/leafeon/front.animated.2bpp.lz"
MediumPic:           INCBIN "gfx/trainers/medium.2bpp.lz"
PinecoFrontpic:      INCBIN "gfx/pokemon/minicorn/front.animated.2bpp.lz"
...
LanturnFrontpic:     INCBIN "gfx/pokemon/numpuff/front.animated.2bpp.lz"
TyrogueFrontpic:     INCBIN "gfx/pokemon/houndoom/front.animated.2bpp.lz"
SkiploomFrontpic:    INCBIN "gfx/pokemon/lykwyse/front.animated.2bpp.lz"
MareepFrontpic:      INCBIN "gfx/pokemon/marill/front.animated.2bpp.lz"
...
AipomFrontpic:       INCBIN "gfx/pokemon/sunflora/front.animated.2bpp.lz"
AbraFrontpic:        INCBIN "gfx/pokemon/abra/front.animated.2bpp.lz"
HitmontopBackpic:    INCBIN "gfx/pokemon/wolfman/back.2bpp.lz"
CloysterBackpic:     INCBIN "gfx/pokemon/cloyster/back.2bpp.lz"
HoothootFrontpic:    INCBIN "gfx/pokemon/mareep/front.animated.2bpp.lz"
...
SlugmaFrontpic:      INCBIN "gfx/pokemon/smoochum/front.animated.2bpp.lz"
...
SmoochumFrontpic:    INCBIN "gfx/pokemon/warwolf/front.animated.2bpp.lz"
JugglerPic:          INCBIN "gfx/trainers/juggler.2bpp.lz"
MarillFrontpic:      INCBIN "gfx/pokemon/crobat/front.animated.2bpp.lz"
...
PupitarFrontpic:     INCBIN "gfx/pokemon/ho_oh/front.animated.2bpp.lz"
...
YanmaBackpic:        INCBIN "gfx/pokemon/twinz/back.2bpp.lz"
...
FeraligatrBackpic:   INCBIN "gfx/pokemon/aquaria/back.2bpp.lz"
...
QwilfishFrontpic:    INCBIN "gfx/pokemon/gohng/front.animated.2bpp.lz"
SuicuneBackpic:      INCBIN "gfx/pokemon/sui/back.2bpp.lz"
SlowkingBackpic:     INCBIN "gfx/pokemon/politoed/back.2bpp.lz"
ElekidBackpic:       INCBIN "gfx/pokemon/porygon2/back.2bpp.lz"
CelebiBackpic:       INCBIN "gfx/pokemon/leafeon/back.2bpp.lz"
...
SunfloraBackpic:     INCBIN "gfx/pokemon/donphan/back.2bpp.lz"
PhanpyFrontpic:      INCBIN "gfx/pokemon/murkrow/front.animated.2bpp.lz"
RhydonBackpic:       INCBIN "gfx/pokemon/rhydon/back.2bpp.lz"
LarvitarFrontpic:    INCBIN "gfx/pokemon/sneasel/front.animated.2bpp.lz"
TyranitarBackpic:    INCBIN "gfx/pokemon/togepi/back.2bpp.lz"
...
LedybaBackpic:       INCBIN "gfx/pokemon/ampharos/back.2bpp.lz"
CyndaquilBackpic:    INCBIN "gfx/pokemon/flambear/back.2bpp.lz"
BayleefBackpic:      INCBIN "gfx/pokemon/blossomole/back.2bpp.lz"
...
HoppipFrontpic:      INCBIN "gfx/pokemon/skarmory/front.animated.2bpp.lz"
...
QuilavaBackpic:      INCBIN "gfx/pokemon/volbear/back.2bpp.lz"
CroconawBackpic:     INCBIN "gfx/pokemon/aqua/back.2bpp.lz"
...
TeddiursaFrontpic:   INCBIN "gfx/pokemon/cottomew/front.animated.2bpp.lz"
...
MagcargoBackpic:     INCBIN "gfx/pokemon/elekid/back.2bpp.lz"
...
QwilfishBackpic:     INCBIN "gfx/pokemon/gohng/back.2bpp.lz"
GligarBackpic:       INCBIN "gfx/pokemon/turbann/back.2bpp.lz"
TyphlosionBackpic:   INCBIN "gfx/pokemon/dynabear/back.2bpp.lz"
...
LedianBackpic:       INCBIN "gfx/pokemon/trifox/back.2bpp.lz"
PupitarBackpic:      INCBIN "gfx/pokemon/ho_oh/back.2bpp.lz"
HeracrossBackpic:    INCBIN "gfx/pokemon/lefmew/back.2bpp.lz"
UnownDFrontpic:      INCBIN "gfx/pokemon/unown_d/front.animated.2bpp.lz"
MiltankBackpic:      INCBIN "gfx/pokemon/steelix/back.2bpp.lz"
SteelixBackpic:      INCBIN "gfx/pokemon/grimey/back.2bpp.lz"
...
ShuckleFrontpic:     INCBIN "gfx/pokemon/puddi/front.animated.2bpp.lz"
PonytaBackpic:       INCBIN "gfx/pokemon/ponyta/back.2bpp.lz"
RemoraidFrontpic:    INCBIN "gfx/pokemon/miltank/front.animated.2bpp.lz"
...
SunkernFrontpic:     INCBIN "gfx/pokemon/phanpy/front.animated.2bpp.lz"
...
SudowoodoBackpic:    INCBIN "gfx/pokemon/spinarak/back.2bpp.lz"
FlaaffyBackpic:      INCBIN "gfx/pokemon/sunmola/back.2bpp.lz"
SentretFrontpic:     INCBIN "gfx/pokemon/hoothoot/front.animated.2bpp.lz"
TogeticBackpic:      INCBIN "gfx/pokemon/natu/back.2bpp.lz"
...
JumpluffBackpic:     INCBIN "gfx/pokemon/douno/back.2bpp.lz"
CooltrainermPic:     INCBIN "gfx/trainers/cooltrainer_m.2bpp.lz"
BlastoiseBackpic:    INCBIN "gfx/pokemon/blastoise/back.2bpp.lz"
MisdreavusBackpic:   INCBIN "gfx/pokemon/slowking/back.2bpp.lz"
TyrogueBackpic:      INCBIN "gfx/pokemon/houndoom/back.2bpp.lz"
GeodudeFrontpic:     INCBIN "gfx/pokemon/geodude/front.animated.2bpp.lz"
ScizorBackpic:       INCBIN "gfx/pokemon/hitmontop/back.2bpp.lz"
GirafarigBackpic:    INCBIN "gfx/pokemon/tripstar/back.2bpp.lz"
StantlerBackpic:     INCBIN "gfx/pokemon/plux/back.2bpp.lz"
SmeargleBackpic:     INCBIN "gfx/pokemon/houndour/back.2bpp.lz"
...
FurretBackpic:       INCBIN "gfx/pokemon/hoohoo/back.2bpp.lz"
...
MareepBackpic:       INCBIN "gfx/pokemon/marill/back.2bpp.lz"
RemoraidBackpic:     INCBIN "gfx/pokemon/miltank/back.2bpp.lz"
DittoFrontpic:       INCBIN "gfx/pokemon/ditto/front.animated.2bpp.lz"
KingdraBackpic:      INCBIN "gfx/pokemon/pangshi/back.2bpp.lz"
CamperPic:           INCBIN "gfx/trainers/camper.2bpp.lz"
WooperFrontpic:      INCBIN "gfx/pokemon/girafarig/front.animated.2bpp.lz"
ClefairyBackpic:     INCBIN "gfx/pokemon/clefairy/back.2bpp.lz"
VenonatBackpic:      INCBIN "gfx/pokemon/venonat/back.2bpp.lz"
BellossomBackpic:    INCBIN "gfx/pokemon/grotess/back.2bpp.lz"
Rival1Pic:           INCBIN "gfx/trainers/rival1.2bpp.lz"
SwinubBackpic:       INCBIN "gfx/pokemon/magby/back.2bpp.lz"
; 158000
...
AriadosBackpic:      INCBIN "gfx/pokemon/gelanla/back.2bpp.lz"
SneaselBackpic:      INCBIN "gfx/pokemon/dandemew/back.2bpp.lz"
UmbreonBackpic:      INCBIN "gfx/pokemon/rinring/back.2bpp.lz"
MurkrowBackpic:      INCBIN "gfx/pokemon/bellboyant/back.2bpp.lz"
...
EnteiBackpic:        INCBIN "gfx/pokemon/en/back.2bpp.lz"
...
HoOhBackpic:         INCBIN "gfx/pokemon/aipom/back.2bpp.lz"
...
AipomBackpic:        INCBIN "gfx/pokemon/sunflora/back.2bpp.lz"
EspeonBackpic:       INCBIN "gfx/pokemon/meowsy/back.2bpp.lz"
WeedleFrontpic:      INCBIN "gfx/pokemon/weedle/front.animated.2bpp.lz"
TotodileBackpic:     INCBIN "gfx/pokemon/cruz/back.2bpp.lz"
SnubbullBackpic:     INCBIN "gfx/pokemon/remoraid/back.2bpp.lz"
...
HoppipBackpic:       INCBIN "gfx/pokemon/skarmory/back.2bpp.lz"
BluePic:             INCBIN "gfx/trainers/blue.2bpp.lz"
GranbullBackpic:     INCBIN "gfx/pokemon/octillery/back.2bpp.lz"
...
SunkernBackpic:      INCBIN "gfx/pokemon/phanpy/back.2bpp.lz"
LaprasBackpic:       INCBIN "gfx/pokemon/lapras/back.2bpp.lz"
MagbyBackpic:        INCBIN "gfx/pokemon/likk/back.2bpp.lz"
DragonairBackpic:    INCBIN "gfx/pokemon/dragonair/back.2bpp.lz"
ZapdosBackpic:       INCBIN "gfx/pokemon/zapdos/back.2bpp.lz"
ChikoritaBackpic:    INCBIN "gfx/pokemon/leef/back.2bpp.lz"
CorsolaBackpic:      INCBIN "gfx/pokemon/belmitt/back.2bpp.lz"
ChinchouBackpic:     INCBIN "gfx/pokemon/qwilfish/back.2bpp.lz"
ChanseyBackpic:      INCBIN "gfx/pokemon/chansey/back.2bpp.lz"
SkiploomBackpic:     INCBIN "gfx/pokemon/lykwyse/back.2bpp.lz"
SpinarakFrontpic:    INCBIN "gfx/pokemon/tangel/front.animated.2bpp.lz"
...
SwinubFrontpic:      INCBIN "gfx/pokemon/magby/front.animated.2bpp.lz"
LarvitarBackpic:     INCBIN "gfx/pokemon/sneasel/back.2bpp.lz"
...
BlisseyBackpic:      INCBIN "gfx/pokemon/kingdra/back.2bpp.lz"
AmpharosBackpic:     INCBIN "gfx/pokemon/anchorage/back.2bpp.lz"
IgglybuffBackpic:    INCBIN "gfx/pokemon/igglybuff/back.2bpp.lz"
AzumarillBackpic:    INCBIN "gfx/pokemon/para/back.2bpp.lz"
OctilleryBackpic:    INCBIN "gfx/pokemon/bomseel/back.2bpp.lz"
UnownSFrontpic:      INCBIN "gfx/pokemon/unown_s/front.animated.2bpp.lz"
HorseaBackpic:       INCBIN "gfx/pokemon/horsea/back.2bpp.lz"
SentretBackpic:      INCBIN "gfx/pokemon/hoothoot/back.2bpp.lz"
...
SpinarakBackpic:     INCBIN "gfx/pokemon/tangel/back.2bpp.lz"
RaikouBackpic:       INCBIN "gfx/pokemon/rai/back.2bpp.lz"
UnownKFrontpic:      INCBIN "gfx/pokemon/unown_k/front.animated.2bpp.lz"
HoundourBackpic:     INCBIN "gfx/pokemon/madame/back.2bpp.lz"
PoliwagBackpic:      INCBIN "gfx/pokemon/poliwag/back.2bpp.lz"
SquirtleBackpic:     INCBIN "gfx/pokemon/squirtle/back.2bpp.lz"
ShuckleBackpic:      INCBIN "gfx/pokemon/puddi/back.2bpp.lz"
...
DunsparceBackpic:    INCBIN "gfx/pokemon/umbreon/back.2bpp.lz"
DonphanBackpic:      INCBIN "gfx/pokemon/blissey/back.2bpp.lz"
WooperBackpic:       INCBIN "gfx/pokemon/girafarig/back.2bpp.lz"
...
MantineBackpic:      INCBIN "gfx/pokemon/kotora/back.2bpp.lz"
UnownLFrontpic:      INCBIN "gfx/pokemon/unown_l/front.animated.2bpp.lz"
PiloswineBackpic:    INCBIN "gfx/pokemon/bellossom/back.2bpp.lz"
...
NatuBackpic:         INCBIN "gfx/pokemon/xatu/back.2bpp.lz"
...
ForretressBackpic:   INCBIN "gfx/pokemon/espeon/back.2bpp.lz"
...
SmoochumBackpic:     INCBIN "gfx/pokemon/warwolf/back.2bpp.lz"
PichuBackpic:        INCBIN "gfx/pokemon/pichu/back.2bpp.lz"
HoundoomBackpic:     INCBIN "gfx/pokemon/kurstraw/back.2bpp.lz"
BellsproutBackpic:   INCBIN "gfx/pokemon/bellsprout/back.2bpp.lz"
GrimerBackpic:       INCBIN "gfx/pokemon/grimer/back.2bpp.lz"
LanturnBackpic:      INCBIN "gfx/pokemon/numpuff/back.2bpp.lz"
...
LugiaBackpic:        INCBIN "gfx/pokemon/snubbull/back.2bpp.lz"
...
PolitoedBackpic:     INCBIN "gfx/pokemon/ariados/back.2bpp.lz"
DragoniteBackpic:    INCBIN "gfx/pokemon/dragonite/back.2bpp.lz"
HitmonleeBackpic:    INCBIN "gfx/pokemon/hitmonlee/back.2bpp.lz"
NatuFrontpic:        INCBIN "gfx/pokemon/xatu/front.animated.2bpp.lz"
UrsaringBackpic:     INCBIN "gfx/pokemon/ballerine/back.2bpp.lz"
SagePic:             INCBIN "gfx/trainers/sage.2bpp.lz"
TeddiursaBackpic:    INCBIN "gfx/pokemon/cottomew/back.2bpp.lz"
PhanpyBackpic:       INCBIN "gfx/pokemon/murkrow/back.2bpp.lz"
UnownVFrontpic:      INCBIN "gfx/pokemon/unown_v/front.animated.2bpp.lz"
KakunaBackpic:       INCBIN "gfx/pokemon/kakuna/back.2bpp.lz"
WobbuffetBackpic:    INCBIN "gfx/pokemon/ledyba/back.2bpp.lz"
TogepiBackpic:       INCBIN "gfx/pokemon/quagsire/back.2bpp.lz"
CrobatBackpic:       INCBIN "gfx/pokemon/rayleep/back.2bpp.lz"

HoothootBackpic:     INCBIN "gfx/pokemon/mareep/back.2bpp.lz"
NoctowlBackpic:      INCBIN "gfx/pokemon/flaaffy/back.2bpp.lz"
MortyPic:            INCBIN "gfx/trainers/morty.2bpp.lz"
SlugmaBackpic:       INCBIN "gfx/pokemon/smoochum/back.2bpp.lz"
...
MeganiumBackpic:     INCBIN "gfx/pokemon/blossomite/back.2bpp.lz"
PicnickerPic:        INCBIN "gfx/trainers/picnicker.2bpp.lz"
LickitungBackpic:    INCBIN "gfx/pokemon/lickitung/back.2bpp.lz"
TogepiFrontpic:      INCBIN "gfx/pokemon/quagsire/front.animated.2bpp.lz"
