...
; ???
	const EVENT_SILVER_SCALE_PLAYER_ALERTED
	const EVENT_GIGA_SAGE_INTRO_GIVEN
	const EVENT_CINNABAR_OLD_SEA_MAP
	const EVENT_MEW_UNUSED
	const EVENT_SHOWN_MAP
	const EVENT_TALKED_TO_EXCITED_SAILOR
	const EVENT_TOOK_KABUTO
	const EVENT_TOOK_OMANYTE
	const EVENT_GOT_REVIVAL_GUY_INTRO
	const EVENT_OUT_OF_FOSSIL_SPACE
	const EVENT_UNUSED
	...
	const EVENT_CERULEAN_CAVE_1BF_ULTRA_BALL
	const EVENT_CERULEAN_CAVE_1BF_MAX_REVIVE
...
; ???
	const EVENT_GOLDENROD_UNDERGROUND_HEART_STONE
	const EVENT_BURNED_TOWER_1F_POISON_STONE
	const EVENT_WHIRL_ISLAND_LUGIA_CHAMBER_ARTICUNO
	const EVENT_WHIRL_ISLAND_LUGIA_CHAMBER_ZAPDOS
	const EVENT_WHIRL_ISLAND_LUGIA_CHAMBER_MOLTRES
	const EVENT_5D1
	const EVENT_5D2
	const EVENT_5D3
	const EVENT_5D4
